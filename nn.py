...
def train(net, data, epochs=10, batch_size=10, seq_length=50, lr=0.0001, clip=5, val_frac=0.1, print_every=10):
    ''' Training a network 
    ...
    for e in range(epochs):
        ...
        for x, y in get_batches(data, batch_size, seq_length):
            ...
            if counter % print_every == 0:
                ...
                print("--- %s seconds per train ---" % (time.time() - start_time))
